...
import { ArrowRight, Bike, Calendar, Ruler, Settings, Truck, Wrench } from "lucide-react";
...
const services = [
  ...
  { icon: Calendar, title: "Rental Bikes", description: "Rent a Bike on day basis pricing. Choose from a wide range of premium bikes for your adventures.", price: "From ₹499", link: "/rental" },
  { icon: Truck, title: "Pickup & Delivery", description: "We'll pick up your bike, service it, and deliver it back. Hassle-free cycling maintenance.", price: "From ₹299", link: "/servicing" },
];
...
const Services = () => (
  <PageShell>
    <section className="relative h-[50vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-5 md:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <h1 className="font-heading text-hero-sm md:text-section text-[#FFFFFF] mb-4">Workshop & Services</h1>
    ...
    <section className="container mx-auto px-5 md:px-8 py-16">
      <RentalBikes />
    </section>

    {/* Supporting Events Section */}
    <section className="container mx-auto px-5 md:px-8 py-16">
      <EventSupport />
    </section>
  </PageShell>
