          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {services.map((service, i) => (
              <motion.div
                ...
                className="glass-card p-6 rounded-lg transition-colors duration-200 group relative overflow-hidden !bg-primary !border-none"
              >
                ...
                />
                <service.icon className="relative w-7 h-7 text-black mb-4 group-hover:scale-110 transition-transform duration-200" />
                <h3 className="relative font-heading font-bold text-white text-base mb-2">
                  {service.title}
                </h3>
                <p className="relative text-black text-small font-body leading-relaxed">
                  {service.description}
                </p>
              </motion.div>
            ))}
