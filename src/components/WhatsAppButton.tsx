    ...
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <motion.a
        ...
        className="relative w-14 h-14 rounded-full flex items-center justify-center overflow-hidden
          ...
          shadow-[0_0_12px_2px_hsl(var(--primary)/0.12),0_4px_16px_-4px_rgba(0,0,0,0.5)]
          hover:shadow-[0_0_18px_4px_hsl(var(--primary)/0.2),0_6px_20px_-4px_rgba(0,0,0,0.6)]
          hover:border-primary/30
          active:shadow-[0_0_8px_1px_hsl(var(--primary)/0.15)]
